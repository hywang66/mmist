...
# experiment settings
exp_name="exp_tist" # experiment name, which determines the output folder name
...
# set up the textual style inputs
sty_text="A sketch with black pencil" # the style text description
